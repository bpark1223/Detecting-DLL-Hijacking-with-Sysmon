...
</p> 5. I want to proceed by building a detection mechanism. I will focus on a specific hijack involving the vulnerable executable calc.exe and a list of DLLs that can be hijacked by performing a reflective DLL attack. I go back to my Command Prompt to copy calc.exe and reflective_dll.x64.dll to the desktop:</p>
